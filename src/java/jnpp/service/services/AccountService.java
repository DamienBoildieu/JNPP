...
public interface AccountService {
    ...
    /**
     * Ouvre un compte joint. 
     * Un compte joint ne peut etre ouvert que part des 
     ...
     * Un compte courant, un compte joint ou un compte livret ne peut etre 
     * ferme que si la quantite d'argent sur ce compte est nulle.
     * Un compte d'action ne peut etre ferme que si ce compte n'a aucun titres 
     * d'action.
     * Un compte joint ne peut etre ferme que si tous les proprietaires du 
     * compte on fait la demande de fermeture.  Si le seul client n'ayant pas 
     * fait de demande de fermeture est le client acutel, le compte joint est 
     * ferme. Si le compte joint n'a pas pu  ferme, une demande de fermeture au 
     * nom du client est generee.
