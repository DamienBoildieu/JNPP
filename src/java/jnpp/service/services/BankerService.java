...
public interface BankerService {
     ...
     * @throws DuplicateShareException Exception levee si une action du meme 
     * nom existe deja.
     */
     ...
     * @throws DuplicateAdvisorException Exception levee si un conseiller du meme
     * nom existe deja.
     */
     ...
     * @throws FakePaymentMeanException Exception levees si l'identifiant ne fait 
     * pas reference a un moyen de paiement existant.
     */
     ...
     * @throws AccountTypeException Exception levee si le compte ne peut pas 
     * supporter cette operation.
     * @throws DebitAuthorizationException Exception levee si le compte d'origine 
     * ne peut pas debiter le compte destination.
     * @throws OverdraftException Exception levee si le compte d'origine ne peut 
     * pas supporter les decouverts.
     */
     ...
     * @throws NoCurrentAccountException Exception levee si le client proprietaire
     * du compte n'a pas de compte courant.
     * @throws AccountTypeException Exception levee si le compte ne peut pas 
     * supporter cette operation.
     */
