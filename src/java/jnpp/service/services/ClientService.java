...
public interface ClientService {
     ...
     * @throws AgeException Exception levee si le particluer n'est pas majeur.
    ...
    /**
     * Mes a jour les informations d'un client.
     * Seul les arguments non null sont modifies.
     * @param login Login du client.
     ...
     * Un client ne peut fermer son compte que si il n'a plus aucun compte 
     * bancaire.
     * @param login Login du client.
     * @param password Mot de passe du client.
     * @throws ClosureException Exception levee si le compte ne peut etre ferme.
     * @throws FakeClientException Exception levee le login ne fait pas reference 
     * a un client existant.
     */
    ...
    /**
     * RAZ du mot de passe d'un particulier.
     * Verifie que les informations font references a un particulier.
     * Si les informations sont bonnes, genere un nouveau mot de passe 
     * aleatoirement pour un particulier et envoit un mail contenant le nouveau 
     * mot de passe.
    ...
    /**
     * RAZ du mot de passe d'un professionel.
     * Verifie que les informations font references a un professionel.
     * Si les informations sont bonnes, genere un nouveau mot de passe 
     * aleatoirement pour un professionel et envoit un mail contenant le nouveau 
     * mot de passe.
