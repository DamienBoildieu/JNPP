...
public interface DebitAuthorizationService {
     ...
     * @throws AccountTypeException Exception levee si le compte origine ne peut
     * pas supporter l'operation de debit.
     */
     ...
     * font pas reference a une autorisation existante.
     * @throws AccountOwnerException Exception levee le client n'est pas
     * proprietaire du compte.
     */
