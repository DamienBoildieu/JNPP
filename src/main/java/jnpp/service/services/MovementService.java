...
public interface MovementService {
     ...
     * @throws FakeAccountException        Exception levee si le rib ne fait pas
     *                                     reference a un compte existant.
     * @throws AccountOwnerException       Exception levee le client fermant le
     *                                     compte n'est pas proprietaire du
     *                                     compte.
     * @throws AccountTypeException        Exception levee si l'un des comptes
     *                                     ne peut pas supporter cette
     *                                     operation.
     * @throws DebitAuthorizationException Exception levee si le compte orgine
     *                                     n'est pas autorise a debiter le
     *                                     compte destination.
     * @throws CurrencyException           Exception levee si la devise passee
     *                                     ne correspond pas a celle du compte
     *                                     origine.
     * @throws OverdraftException          Exception levee si le compte
     *                                     destination ne peut pas supporter les
     *                                     decouverts.
     */
     ...
     *                                   existante.
     */
    PurchaseDTO purchaseShareTitles(String login, String name, Integer amount,
     ...
     */
    SaleDTO saleShareTitles(String login, String name, Integer amount,
            String label) throws FakeClientException, NoCurrentAccountException,
