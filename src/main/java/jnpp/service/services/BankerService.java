...
public interface BankerService {
     ...
     */
    LoginDTO getLogin(String login) throws FakeClientException;
     ...
     *                                  fait pas reference a un moyen de
     *                                  paiement existant.
     */
    PaymentMeanDTO upgradePaymentMean(String id)
     ...
     * @throws AccountTypeException Exception levee si le compte ne peut pas
     *                              supporter cette operation.
     * @throws OverdraftException   Exception levee si le compte d'origine ne
     *                              peut pas supporter les decouverts.
     */
    TransfertDTO transfert(String ribFrom, String ribTo, Double amount,
     ...
     * @throws FakeAccountException        Exception levee si le rib ne fait pas
     *                                     reference a un compte existant.
     * @throws AccountTypeException        Exception levee si le compte ne peut
     *                                     pas supporter cette operation.
     * @throws DebitAuthorizationException Exception levee si le compte
     *                                     d'origine ne peut pas debiter le
     *                                     compte destination.
     * @throws OverdraftException          Exception levee si le compte
     *                                     d'origine ne peut pas supporter les
     *                                     decouverts.
     */
    DebitDTO debit(String ribFrom, String ribTo, Double amount,
     ...
     * @throws FakeAccountException      Exception levee si le rib ne fait pas
     *                                   reference a un compte existant.
     * @throws FakeShareException        Exceptin levee si le nom de l'action ne
     *                                   fait pas reference a une action
     *                                   existante.
     * @throws NoCurrentAccountException Exception levee si le client
     *                                   proprietaire du compte n'a pas de
     *                                   compte courant.
     * @throws AccountTypeException      Exception levee si le compte ne peut
     *                                   pas supporter cette operation.
     */
     ...
     * @throws AccountTypeException      Exception levee si le compte ne peut
     *                                   pas supporter cette operation.
     * @throws AmountException           Exception levee si la quantite d'action
     *                                   a vendre est superieur a nombre de
     *                                   titres d'actions poseedes.
     * @throws FakeShareTitleException   Exception levee si le rib et le nom de
     *                                   l'action de font pas reference a un
     *                                   titre d'action existant.
     */
