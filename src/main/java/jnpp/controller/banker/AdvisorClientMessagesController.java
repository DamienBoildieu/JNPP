...
public class AdvisorClientMessagesController {
    ...
    protected ModelAndView advisorClientMessagesGet(
        ...
        try {
            ...
            ModelAndView mv = new ModelAndView(
                    "banker/advisor_client_message_board");
    ...
    protected ModelAndView advisorClientMessagesPost(
            HttpServletRequest request) {
        String login = request.getParameter("login");
        ...
        if (login == null || login.length() == 0 || content == null
            ...
            return new ModelAndView(
                    "redirect:/banquier/conseiller/client/messages.htm?login="
                            + login);
        }
        try {
