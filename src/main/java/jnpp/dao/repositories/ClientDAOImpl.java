...
@Repository
public class ClientDAOImpl extends GenericDAOImpl<ClientEntity>
        implements ClientDAO {

    @Transactional(readOnly = true)
    @Override
    public PrivateEntity findPrivateByIdentity(IdentityEntity.Gender gender,
    ...
    @Transactional(readOnly = true)
    @Override
    public ProfessionalEntity findProfessionalByNameIdentity(String name,
            IdentityEntity.Gender ownerGender, String ownerFirstname,
            String ownerLastname) {
        Query query = getEm()
                .createNamedQuery("find_professional_by_name_identity");
