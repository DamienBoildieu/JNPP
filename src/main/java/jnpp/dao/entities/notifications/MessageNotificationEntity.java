...
public class MessageNotificationEntity extends NotificationEntity
    ...
    public MessageNotificationEntity(ClientEntity client, Date date,
            Boolean seen, MessageEntity message) {
    ...
    public String toString() {
        return "jnpp.dao.entities.notifications.MessageNotificationEntity[ id="
                + getId() + " ]";
    }

    @Override
    public MessageNotificationDTO toDTO() {
        return new MessageNotificationDTO(getId(), getDate(), getSeen(),
                message.toDTO());
    }
