...
public class MovementNotificationEntity extends NotificationEntity
    ...
    public MovementNotificationEntity(ClientEntity client, Date date,
            Boolean seen, MovementEntity movement) {
    ...
    public String toString() {
        return "jnpp.dao.entities.notifications.MovementNotificationEntity[ id="
                + getId() + " ]";
    }

    @Override
    public MovementNotificationDTO toDTO() {
        return new MovementNotificationDTO(getId(), getDate(), getSeen(),
                movement.toDTO());
    }
